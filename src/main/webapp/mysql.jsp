...
<html>
<head>
    <title>Product Provisioning - MySQL</title>
	    ...
	    <div class="body-content">	
					...
					<nav class="side-navigation">
					  <ul class="mainmenu">
						...
						<li><a> <i class="fa fa-database" aria-hidden="true"></i> &nbsp;&nbsp;Database</a>
							<ul class="submenu">
									<li><a href=""><img src="https://pbs.twimg.com/profile_images/1240079072/logo-mysql-170x170_400x400.png" alt="Icon" width="32" height="22" align="left" hspace="10" /></image>MySQL</a></li>
				  ...
				  <div style="margin-left:250px;height:90.85%;"> 				   
								...
								<div style="width:20%;border-left:1px solid #106677;float:right;height:100%">
								   ...
								   <div style="padding:8px;font-weight:bold;font-size:18px;"> <center>My SQL</center> </div>
								    <img src="https://pbs.twimg.com/profile_images/1240079072/logo-mysql-170x170_400x400.png" width="100%" height="100px" />
									...
									<div>
									    <ol type="1">
										  ...
										  <li>Use group name <b>[mysql]</b>.</li>
									...
									<div>
											...
											<p style="padding:0px 10px;">The above hosts file installs mysql server on 10.1.2.3 and 10.1.2.4	</p>								  
									</div>
								</div>						
