...
<html>
<head>
    <title>Product Provisioning - Docker</title>
	  ...
	  <div class="fixed-header">
	    ...
	    <div class="body-content">	
					...
					<nav class="side-navigation">
					  <ul class="mainmenu">
						...
						<li><a> <i class="fa fa-cubes" aria-hidden="true"></i> &nbsp;Orchestration/Containers</a>
						  <ul class="submenu">
							<li><a href=""><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKy3dY6wiOT9YlJRR0MTzkhhpUlSzoGAfzY8LcqBrgQWFTGjjR" alt="Icon" width="32" height="22" align="left" hspace="10" /></image>Docker CE</a></li>
				  ...
				  <div style="margin-left:250px;height:90.85%;"> 				   
								...
								<!-- main content right -->
								<div style="width:20%;border-left:1px solid #106677;float:right;height:100%;overflow-y:scroll;">
								
								   <div style="padding:8px;font-weight:bold;font-size:18px;"> <center>Docker CE</center> </div>
								    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKy3dY6wiOT9YlJRR0MTzkhhpUlSzoGAfzY8LcqBrgQWFTGjjR" width="100%" height="100px" />
									...
									<div>
									    <ol type="1">
										  ...
										  <li>Use group name <b>[dee-nodes]</b>.</li>
									...
									<div>
											...
											<p style="padding:0px 10px;">The above hosts file installs docker on 10.1.2.3 and 10.1.2.4	</p>								  
									</div>
								</div>						
